...
class CollectionSearchState extends State<CollectionSearch> {
  ...
  Widget build(BuildContext context) {
    ...
    this.tileWidth = (MediaQuery.of(context).size.width -
            16 -
      ...
      builder: (context, collection, _) => Scaffold(
        ...
        body: ListView(
          children: <Widget>[
                ...
                this.albums
                    ? Container()
                    : SubHeader(language.STRING_LOCAL_SEARCH_ALBUM_SUBHEADER),
                this.albums
                    ? Container()
                    : Container(
                ...
                this.tracks
                    ? Container()
                    : SubHeader(language.STRING_LOCAL_SEARCH_TRACK_SUBHEADER),
              ] +
