...
class Collection extends ChangeNotifier {
  ...
  static Future<void> init(
      ...
      @required Directory cacheDirectory}) async {
    ...
    if (!await File(path.join(this.cacheDirectory.path, 'collection.JSON'))
      ...
      if (collectionDirectoryContent.length != this.tracks.length) {
        collectionDirectoryContent
            .asMap()
            .forEach((int index, FileSystemEntity file) async {
  ...
  Future<void> sort(
      {CollectionSort type: CollectionSort.dateAdded,
